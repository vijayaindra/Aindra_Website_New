  ...
  return (
    <header className="w-full px-6 py-4 flex items-center justify-between bg-white border-b border-gray-50">
      <div className="flex items-center space-x-2">
        <span className="text-2xl font-bold tracking-tight text-[#00AEEF] flex items-center">
      ...
      <div className="flex items-center space-x-3">
        ...
        <button className="px-6 py-2.5 bg-[#00AEEF] text-white font-bold text-sm rounded-full hover:bg-blue-600 transition-shadow shadow-md">
          Contact us
        </button>
      </div>
    </header>
