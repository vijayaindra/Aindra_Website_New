...
const Hero: React.FC = () => {
  return (
    <section className="px-6 pt-4 pb-12">
      <div className="mb-6">
        <h1 className="text-7xl font-extrabold tracking-tight text-gray-900 mb-2">Clustr</h1>
        <p className="text-xl text-gray-600 font-medium">Precision Staining Seamlessly Scaled</p>
      </div>
