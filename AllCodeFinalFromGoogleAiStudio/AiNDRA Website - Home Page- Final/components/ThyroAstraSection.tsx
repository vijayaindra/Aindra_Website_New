...
export const ThyroAstraSection: React.FC = () => {
  return (
    <section className="py-24 px-6 md:px-12 lg:px-24 bg-[#f1f5f9] flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-12 gap-12 lg:gap-24 items-center">
          ...
          {/* Right: Medical Illustration (Thyroid Region) */}
          <div className="col-span-12 lg:col-span-7 order-1 lg:order-2">
            <div className="relative rounded-[2.5rem] overflow-hidden shadow-xl bg-white aspect-[4/3] lg:aspect-auto">
              ...
              {/* Highlight Overlay (Simulating the glowing tumor in thyroid area as seen in screenshot) */}
              <div className="absolute top-[48%] left-[58%] w-16 h-16 bg-orange-400/40 blur-2xl rounded-full animate-pulse"></div>
              <div className="absolute top-[52%] left-[61%] w-7 h-7 bg-orange-300 rounded-full shadow-[0_0_20px_rgba(251,146,60,0.9)] border border-white/20"></div>
