...
const AIAssistant: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const result = await getBiotechInsight(`User question about Aindra Astra or Biotech: ${input}`);
    setAnswer(result);
    setLoading(false);
  };
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-80 md:w-96 overflow-hidden border border-gray-100 animate-in fade-in slide-in-from-bottom-4 duration-300">
          <div className="bg-blue-600 p-4 text-white flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold">Astra AI Insights</span>
            </div>
          ...
          <div className="p-4 max-h-96 overflow-y-auto bg-gray-50 min-h-[100px]">
            {answer ? (
              ...
              <p className="text-sm text-gray-500">
                Ask me about precision staining, automated pathology, or how Astra's AI technology works.
              </p>
            )}
            {loading && (
