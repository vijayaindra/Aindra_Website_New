  ...
  return (
    <header className="w-full px-6 py-4 flex items-center justify-between bg-white relative z-50">
      <div className="flex items-center">
        <span className="text-2xl font-semibold tracking-tight text-[#00AEEF]">AiNDRA</span>
      </div>
      ...
      <div className="flex items-center space-x-3">
        ...
        <button className="px-8 py-3 bg-[#00AEEF] text-white font-semibold rounded-full hover:bg-[#0096ce] transition-shadow shadow-md text-sm">
          Contact us
        </button>
      </div>
    </header>
