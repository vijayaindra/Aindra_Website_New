...
const faqs: FAQItem[] = [
  {
    id: "01",
    question: "What is the maximum resolution of the Intellistain whole slide scanner?",
    answer: "Intellistain offers sub-micron resolution, typically 0.25 to 0.5 µm/pixel. This ensures that even the most minute cellular details are captured with diagnostic-grade clarity, matching or exceeding traditional high-power microscopy."
  },
  {
    id: "02",
  ...
  {
    id: "03",
    question: "What slide formats and sizes are compatible with the Intellistain system?",
    answer: "Intellistain is optimized for standard 25 x 75 mm (1 x 3 inch) glass slides. It handles a wide range of preparations, including H&E stained histology, cytology smears, and immunohistochemistry (IHC) slides."
  },
  {
    id: "04",
    question: "Can the scanner operate in a high-volume pathology laboratory?",
    answer: "Yes. While the compact Intellistain series is ideal for on-demand and remote settings, our architecture is designed for reliability and high throughput. Our fully automated systems can run 24/7 to meet the demands of busy diagnostic centers."
  },
  {
    id: "05",
  ...
  },
  {
    ...
    answer: "Absolutely. Intellistain is integrated with our cloud-native platform, allowing pathologists to securely view, annotate, and share digitized slides for peer review or second opinions from any authorized device globally."
  },
  {
    id: "07",
  ...
  {
    id: "08",
    question: "Is the Intellistain software compliant with medical data privacy regulations like HIPAA?",
  ...
  return (
    <section className="w-full bg-white py-24 px-4 md:px-8">
      <div className="flex flex-col md:flex-row w-full max-w-[1440px] mx-auto">
        <div className="w-[120px] md:w-[160px] shrink-0 pt-2 mr-6 md:mr-10">
