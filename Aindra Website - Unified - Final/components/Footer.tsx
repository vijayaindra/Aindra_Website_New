        ...
        <div className="flex flex-col md:flex-row border-b border-slate-300 pb-12 md:pb-16">
          ...
          <div className="flex-[1.2] flex flex-col sm:flex-row justify-between pt-8 md:pt-0 gap-8">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <a href="#/astra" className="block text-base md:text-lg font-medium text-slate-900 hover:text-[#00a3ff] transition-colors">Solutions</a>
              <a href="#/about" className="block text-base md:text-lg font-medium text-slate-900 hover:text-[#00a3ff] transition-colors">About</a>
