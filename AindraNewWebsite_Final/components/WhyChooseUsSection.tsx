    ...
    <section className="relative py-16 md:py-32 px-6 md:px-12 lg:px-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-12 gap-8 lg:gap-24 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 flex items-center justify-center lg:justify-end py-8 md:py-12 order-1 lg:order-2 overflow-hidden lg:overflow-visible">
            <div className="relative w-full max-w-[460px] md:max-w-[520px]">
              <div className="grid grid-cols-4 grid-rows-4 gap-2 sm:gap-3 md:gap-4 w-full">
                
                {/* Row 1 */}
                <div className="col-span-2 row-span-1 bg-[#005bc4] rounded-full h-20 sm:h-24 md:h-28 flex items-center px-4 md:px-6 text-white space-x-2 sm:space-x-3 md:space-x-4 shadow-xl">
                ...
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full border-2 border-blue-500/40"></div>
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full border-2 border-blue-500/40"></div>

                {/* Row 2 */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-[#005bc4] flex items-center justify-center shadow-xl">
                ...
                {/* Row 3 */}
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full border-2 border-blue-500/40"></div>
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full bg-[#005bc4] flex items-center justify-center text-center p-2 sm:p-3 md:p-4 shadow-xl">
                  <span className="text-[10px] text-white leading-tight font-medium uppercase tracking-wider">Through validated algorithms</span>
                </div>
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full border-2 border-blue-500/40"></div>
                <div className="row-span-2 col-start-4 bg-[#005bc4] rounded-full w-20 sm:w-24 md:w-28 h-[170px] sm:h-[205px] md:h-[240px] flex flex-col items-center justify-between py-5 sm:py-8 md:py-10 text-white text-center shadow-xl -mt-2 md:-mt-4">
