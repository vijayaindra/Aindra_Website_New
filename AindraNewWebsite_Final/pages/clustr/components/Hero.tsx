      ...
      <div className={`product-hero-body flex flex-col md:flex-row ${sectionShell} ${sectionContainerWide} relative`}>
        <div className="w-full md:w-1/2 z-10 pr-0 md:pr-14 lg:pr-20">
          ...
          <p className="product-hero-description text-gray-500 font-normal">
            ClustrPath is a telepathology platform that enables labs and pathologists
            to view, analyze, share, and report high-resolution digital slide images
            remotely, making pathology workflows faster, collaborative, and more efficient.
          </p>
        </div>
