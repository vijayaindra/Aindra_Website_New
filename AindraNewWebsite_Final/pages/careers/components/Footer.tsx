...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#f1f3f5] pt-14 md:pt-16 lg:pt-20 pb-10 px-4 md:px-6 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-12 md:pb-14">
          ...
          <div className="flex flex-col sm:flex-row gap-10 lg:gap-16 relative">
            ...
            <div className="sm:ml-auto">
              <a href="https://www.linkedin.com/company/aindra-systems/" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full border-2 border-black flex items-center justify-center hover:bg-black hover:text-white transition-all group">
