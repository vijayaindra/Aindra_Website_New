...
const Hero: React.FC = () => {
  return (
    <section className="px-6 pt-4 pb-20">
      <div className="mb-6">
        <h1 className="text-7xl font-extrabold tracking-tight text-gray-900 mb-2">About us</h1>
        <p className="text-xl text-gray-600 font-medium mb-6">Precision Staining Seamlessly Scaled</p>
      ...
      <div className="w-full text-center px-4 md:px-8 mb-20">
